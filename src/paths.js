...
exports.init = () => {
  ...
  userData = (process.env.DISCORD_USER_DATA_DIR !== null && process.env.DISCORD_USER_DATA_DIR !== undefined) ? process.env.DISCORD_USER_DATA_DIR : join(app.getPath('appData'), appDir);
